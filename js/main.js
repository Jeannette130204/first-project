const urlOpt =
    [
        ...
        // "https://www.pngitem.com/pimgs/m/29-292412_poker-chips-png-clipart-png-download-clip-art.png"
    ]
let firstSlot = null;
let secondSlot = null;
let thirdSlot = null;
...
function slotMv() {
    ...
    setTimeout(function () { slot1.src = urlOpt[firstSlot] }, 1800);
    ...
    setTimeout(function () { slot2.src = urlOpt[secondSlot] }, 2200);
    ...
    setTimeout(function () { slot3.src = urlOpt[thirdSlot] }, 2600);
    ...
    if (coinsEl >= 1) {
        ...
        if ((firstSlot === secondSlot) && (firstSlot === thirdSlot)) {
            if (firstSlot === 0) {
                ...
                setTimeout(function () { h1El.innerHTML = "Jackpot!!!" }, 2600);

            }

            else {
                coinsEl = coinsEl + 3;
                setTimeout(function () { h1El.innerHTML = "You win 3 coins" }, 2600);
            }
        } else {
            coinsEl = coinsEl - 1;
        ...
        setTimeout(function () { coinsCh.innerHTML = 'Total Coins: ' + coinsEl; }, 2600);
    ...
    if (coinsEl >= 5) {
        ...
        if ((firstSlot === secondSlot) && (firstSlot === thirdSlot)) {
            if (firstSlot === 0) {
                ...
                coinsEl = coinsEl + 15;
                setTimeout(function () { h1El.innerHTML = "You win 15 coins" }, 2600);
            }
        } else {
            coinsEl = coinsEl - 5;
            h1El.innerHTML = "Slot Machine"
    ...
    if (coinsEl >= 10) {
        ...
        if ((firstSlot === secondSlot) && (firstSlot === thirdSlot)) {
            if (firstSlot === 0) {
                ...
                coinsEl = coinsEl + 30;
                setTimeout(function () { h1El.innerHTML = "You win 30 coins" }, 2600);
            }
        } else {
            coinsEl = coinsEl - 10;
            h1El.innerHTML = "Slot Machine"
